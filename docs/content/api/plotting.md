...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_lead/">plot_lead</a>(lead, peaks=None, title=None, show_grid=True, figsize=(12,3), ax=None)</code></td>
      <td>Single lead waveform with optional R-peak markers. ECG-style grid with major lines every 0.2s / 0.5mV.</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/plot_leads/">plot_leads</a>(leads, peaks_dict=None, title=None, show_grid=True, figsize=(12,None), share_x=True)</code></td>
    ...
    <tr>
      <td><code><a href="/api/ref/plot_12lead/">plot_12lead</a>(leads, record=None, paper_speed=25, amplitude=10, rhythm_lead="II", duration=10.0, figsize=(14,10))</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_peaks/">plot_peaks</a>(lead, peaks=None, title=None, figsize=(12,3), ax=None)</code></td>
    ...
    <tr>
      <td><code><a href="/api/ref/plot_beats/">plot_beats</a>(lead, beats=None, peaks=None, overlay=True, figsize=(8,5), ax=None)</code></td>
    ...
    <tr>
      <td><code><a href="/api/ref/plot_average_beat/">plot_average_beat</a>(lead, peaks=None, before=0.2, after=0.4, figsize=(6,4), ax=None)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_spectrum/">plot_spectrum</a>(lead, method="welch", figsize=(10,4), ax=None)</code></td>
      <td><code>"welch"</code>: PSD in dB/Hz. <code>"fft"</code>: magnitude spectrum. Shaded ECG band (0.05–150 Hz).</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/plot_spectrogram/">plot_spectrogram</a>(lead, nperseg=256, figsize=(12,4), ax=None)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_rr_tachogram/">plot_rr_tachogram</a>(rr_ms, figsize=(10,3), ax=None)</code></td>
      <td>RR intervals vs. beat number with mean ± SD reference lines.</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/plot_poincare/">plot_poincare</a>(rr_ms, figsize=(6,6), ax=None)</code></td>
      <td>Poincaré plot: RR(n) vs RR(n+1) with SD1/SD2 ellipse and identity line.</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/plot_hrv_summary/">plot_hrv_summary</a>(rr_ms, figsize=(14,8))</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_quality/">plot_quality</a>(leads, figsize=(10,5))</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/plot_report/">plot_report</a>(record, figsize=(16,20))</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/iplot_lead/">iplot_lead</a>(lead, peaks=None, title=None, height=300)</code></td>
      <td>Interactive single lead with rangeslider, crosshair spikes, hover showing time and amplitude.</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/iplot_leads/">iplot_leads</a>(leads, peaks_dict=None, title=None, height=None)</code></td>
    ...
    <tr>
      <td><code><a href="/api/ref/iplot_12lead/">iplot_12lead</a>(leads, record=None, duration=10.0, height=800)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/iplot_peaks/">iplot_peaks</a>(lead, peaks=None, title=None, height=350)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/iplot_spectrum/">iplot_spectrum</a>(lead, method="welch", height=400)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/iplot_rr_tachogram/">iplot_rr_tachogram</a>(rr_ms, height=300)</code></td>
      <td>Interactive RR tachogram with mean ± SD lines. Hover shows beat number and RR value.</td>
    </tr>
    <tr>
      <td><code><a href="/api/ref/iplot_poincare/">iplot_poincare</a>(rr_ms, height=500)</code></td>
...
<table>
  ...
  <tbody>
    <tr>
      <td><code><a href="/api/ref/iplot_report/">iplot_report</a>(record, height=1200)</code></td>
